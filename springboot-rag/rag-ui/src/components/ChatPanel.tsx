...
import type { Message, ChatResponse, GraphData } from './types'
...
function ChatPanel({ onGraphUpdate }: Props) {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setMessages(prev => [...prev, { role: 'assistant', content: res.data.answer, duration: elapsed }])
      onGraphUpdate(res.data.graph)
    } catch {
